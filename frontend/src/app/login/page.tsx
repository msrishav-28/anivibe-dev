    ...
    <div className="relative flex min-h-screen items-center justify-center p-4">
      ...
      >
        <div className="mb-8 text-center">
          <GlitchText text="SYSTEM ACCESS" as="h1" className="mb-2 text-3xl text-white" />
          <p className="font-mono text-sm uppercase tracking-widest text-primary-400">Identify Yourself</p>
        </div>
